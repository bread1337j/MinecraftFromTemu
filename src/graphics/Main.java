...
public class Main {
	...
	*/
	public static void gfxParse(Scanner sc, EdgeMatrix edges, Matrix transform, Screen s, Color c) {
        Commands.init(edges, transform, s, c);
		Parser.init();
        Parser p = new Parser(sc, edges, transform);
        p.run();
	}//gfxParse
